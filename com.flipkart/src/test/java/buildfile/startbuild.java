package buildfile;
	...
	class flipkartTEST01 implements Runnable {
		public void run() {
			Hashtable<String, String> capsHashtable = new Hashtable<String, String>();
			capsHashtable.put("browser", "chrome");
			capsHashtable.put("browser_version", "91.0");
			capsHashtable.put("os", "Windows");
			capsHashtable.put("os_version", "8.1");
	...
	public class mainTestClass {
		public static final String USERNAME = "pankajgahlot_taYIg9";
		public static final String AUTOMATE_KEY = "Sze6iYakyvsqY48WwTFz";
		public static final String URL = "https://" + USERNAME + ":" + AUTOMATE_KEY + "@hub-cloud.browserstack.com/wd/hub";
		public void main(String[] args) throws Exception {
			Thread object1 = new Thread(new flipkartTEST01());
			object1.start();
